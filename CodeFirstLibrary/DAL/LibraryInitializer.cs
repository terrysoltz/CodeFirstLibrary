...
namespace CodeFirstLibrary.DAL
{
    public class LibraryInitializer : DropCreateDatabaseIfModelChanges<LibraryContext>
    {
        ...
        { 
            ...
            {
                new Borrower{BorrowerID = 1, Name = "John Doe", Address = "111 Oak St Anytown OR", Phone = "503-555-1234"},
                new Borrower{BorrowerID = 2, Name = "Jane Doe", Address = "111 Oak St Anytown OR", Phone = "503-555-1234"},
                new Borrower{BorrowerID = 3, Name = "Timothy Smith", Address = "512 Daisy Lane Anytown OR", Phone = "503-555-9956"},
                new Borrower{BorrowerID = 4, Name = "Rufus Sasparilla", Address = "4065 NW 45th Ave Anytown OR", Phone = "503-555-5147"},
                new Borrower{BorrowerID = 5, Name = "Jennifer Miller", Address = "555 Broadway Anytown OR", Phone = "503-555-8456"},
                new Borrower{BorrowerID = 6, Name = "Ford Prefect", Address = "42 Galaxy Way Anytown OR", Phone = "503-555-4242"},
                new Borrower{BorrowerID = 7, Name = "Grim Reaper", Address = "1 Dead End Lane Anytown OR", Phone = "503-555-0000"},
                new Borrower{BorrowerID = 8, Name = "Terry Soltz", Address = "100 NE 28th Ave Anytown OR", Phone = "503-555-3214"}
            };

            borrowers.ForEach(s => context.Borrowers.Add(s));
            context.SaveChanges();

            var loans = new List<Loan>
            {
                new Loan{LoanID = 1, BookID = 1, BranchID = 1, BorrowerID = 1, DateOut = DateTime.Parse("2016-12-20"), DueDate = DateTime.Parse("2017-01-20")},
                new Loan{LoanID = 2, BookID = 1, BranchID = 2, BorrowerID = 3, DateOut = DateTime.Parse("2016-12-22"), DueDate = DateTime.Parse("2017-01-22")},
                new Loan{LoanID = 3, BookID = 1, BranchID = 1, BorrowerID = 6, DateOut = DateTime.Parse("2016-12-10"), DueDate = DateTime.Parse("2017-01-10")},
                new Loan{LoanID = 4, BookID = 2, BranchID = 3, BorrowerID = 8, DateOut = DateTime.Parse("2016-12-27"), DueDate = DateTime.Parse("2017-01-20")},
                new Loan{LoanID = 5, BookID = 3, BranchID = 1, BorrowerID = 4, DateOut = DateTime.Parse("2016-12-26"), DueDate = DateTime.Parse("2017-01-26")},
                new Loan{LoanID = 6, BookID = 4, BranchID = 2, BorrowerID = 2, DateOut = DateTime.Parse("2016-12-06"), DueDate = DateTime.Parse("2017-01-06")},
                new Loan{LoanID = 7, BookID = 4, BranchID = 3, BorrowerID = 8, DateOut = DateTime.Parse("2016-12-06"), DueDate = DateTime.Parse("2017-01-06")},
                new Loan{LoanID = 8, BookID = 5, BranchID = 1, BorrowerID = 1, DateOut = DateTime.Parse("2016-12-09"), DueDate = DateTime.Parse("2017-01-09")},
                new Loan{LoanID = 9, BookID = 5, BranchID = 1, BorrowerID = 7, DateOut = DateTime.Parse("2016-12-15"), DueDate = DateTime.Parse("2017-01-15")},
                new Loan{LoanID = 10, BookID = 5, BranchID = 4, BorrowerID = 3, DateOut = DateTime.Parse("2016-12-18"), DueDate = DateTime.Parse("2017-01-18")},
                new Loan{LoanID = 11, BookID = 6, BranchID = 1, BorrowerID = 1, DateOut = DateTime.Parse("2016-12-09"), DueDate = DateTime.Parse("2017-01-09")},
                new Loan{LoanID = 12, BookID = 6, BranchID = 4, BorrowerID = 3, DateOut = DateTime.Parse("2016-12-18"), DueDate = DateTime.Parse("2017-01-18")},
                new Loan{LoanID = 13, BookID = 6, BranchID = 3, BorrowerID = 8, DateOut = DateTime.Parse("2016-12-06"), DueDate = DateTime.Parse("2017-01-06")},
                new Loan{LoanID = 14, BookID = 7, BranchID = 1, BorrowerID = 1, DateOut = DateTime.Parse("2016-12-09"), DueDate = DateTime.Parse("2016-01-09")},
                new Loan{LoanID = 15, BookID = 8, BranchID = 3, BorrowerID = 8, DateOut = DateTime.Parse("2016-12-15"), DueDate = DateTime.Parse("2017-01-15")},
                new Loan{LoanID = 16, BookID = 8, BranchID = 1, BorrowerID = 2, DateOut = DateTime.Parse("2016-12-06"), DueDate = DateTime.Parse("2017-01-06")},
                new Loan{LoanID = 17, BookID = 10, BranchID = 1, BorrowerID = 1, DateOut = DateTime.Parse("2016-12-20"), DueDate = DateTime.Parse("2017-01-20")},
                new Loan{LoanID = 18, BookID = 10, BranchID = 1, BorrowerID = 3, DateOut = DateTime.Parse("2016-12-10"), DueDate = DateTime.Parse("2017-01-10")},
                new Loan{LoanID = 19, BookID = 10, BranchID = 2, BorrowerID = 2, DateOut = DateTime.Parse("2016-12-06"), DueDate = DateTime.Parse("2017-01-06")},
                new Loan{LoanID = 20, BookID = 10, BranchID = 4, BorrowerID = 6, DateOut = DateTime.Parse("2016-12-07"), DueDate = DateTime.Parse("2017-01-07")}
            };
...
/*
11,2,2,2016-12-09,2017-01-09
11,3,8,2016-12-12,2017-01-12
11,3,6,2016-12-15,2017-01-15
12,2,2,2016-12-09,2016-01-09
12,3,6,2016-12-15,2016-01-15
13,1,1,2016-12-22,2016-01-22
13,2,3,2016-12-06,2017-01-06
13,4,6,2016-12-26,2017-01-26
14,2,3,2016-12-09,2016-01-09
14,3,6,2016-12-09,2017-01-09
14,4,8,2016-12-20,2017-01-20
15,1,1,2016-12-06,2017-01-06
16,1,1,2016-12-06,2017-01-06
17,1,2,2016-12-09,2017-01-09
17,1,3,2016-12-07,2017-01-07
17,2,7,2016-12-07,2017-01-07
18,1,3,2016-12-15,2017-01-15
18,4,7,2016-12-07,2017-01-07
19,3,7,2016-12-07,2017-01-07
19,3,8,2016-12-06,2017-01-06
19,1,1,2016-12-15,2017-01-15
20,1,1,2016-12-15,2016-01-15
20,1,3,2016-12-18,2017-01-18
20,2,4,2016-12-06,2017-01-06
20,3,6,2016-12-19,2017-01-19
20,3,8,2016-12-09,2017-01-09
21,1,1,2016-12-15,2017-01-15
21,1,3,2016-12-18,2017-01-18
21,2,4,2016-12-06,2017-01-06
21,2,8,2016-12-09,2017-12-09
*/